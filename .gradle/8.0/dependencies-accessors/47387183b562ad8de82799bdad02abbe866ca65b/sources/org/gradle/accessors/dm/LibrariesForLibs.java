...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxUiToolingLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at androidx.ui.tooling.preview
         */
        public AndroidxUiToolingPreviewLibraryAccessors getPreview() { return laccForAndroidxUiToolingPreviewLibraryAccessors; }
    ...
    public static class AndroidxUiToolingPreviewLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxUiToolingPreviewLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for android (androidx.compose.ui:ui-tooling-preview-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() { return create("androidx.ui.tooling.preview.android"); }
    ...
    public static class CoroutinesVersionAccessors extends VersionFactory  {
        ...
        public CoroutinesVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: coroutines.test (1.7.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        public NavigationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: navigation.compose (2.7.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class OrgJetbrainsKotlinVersionAccessors extends VersionFactory  {
        ...
        public OrgJetbrainsKotlinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.jetbrains.kotlin.android (1.8.22)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
